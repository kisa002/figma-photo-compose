package com.haeyum.figmaphoto.scenarios.register
...
import com.haeyum.figmaphoto.scenarios.register.ui.theme.FigmaPhotoTheme
    ...
    FigmaPhotoTheme {
        Column(
            ...
            Button(
                ...
                Text(text = "NEXT", color = Color.White, fontWeight = FontWeight(900), modifier = Modifier.padding(10.dp))
            }
        }
    }
